...
1. Create a browser source using the following URL: `https://cookieshakes.github.io`
   - To customise the focus and break time lengths use the following URL instead: `https://cookieshakes.github.io/?pomodoro=45&shortBreak=10&longBreak=15` (replacing `45`, `10` and `15` with minute values as desired.)
